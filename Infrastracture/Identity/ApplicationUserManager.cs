...
namespace Finance.Infrastructure.Identity
{
    ...
    {
        private UserStore<ApplicationUser, ApplicationRole, FinanceContext, string, IdentityUserClaim<string>
        ...
        private FinanceContext GetContext()
        {
            _store = (UserStore<ApplicationUser, ApplicationRole, FinanceContext, string, IdentityUserClaim<string>,
        ...
        {
            var context = GetContext();
            return await context.Users.FirstOrDefaultAsync(x => x.NormalizedEmail == email.Normalize());
        }
